...
public class SettingsMenu : MonoBehaviour
{
    ...
    public GameObject menu; // The Settings menu GameObject
    ...
    void Start()
    {
        ...
        Debug.Log("Settings Menu initialized: Closed");
    }
    ...
    public void ToggleMenu()
    {
        if (isMenuOpen)
        {
            Debug.Log("ToggleMenu: Closing Settings Menu");
            CloseMenu();
        }
        else
        {
            Debug.Log("ToggleMenu: Opening Settings Menu");
            OpenMenu();
        }
    }
    ...
    private void DisableGameUI()
    {
        if (gameUI != null)
        {
            ...
            Debug.Log("Game UI disabled for Settings Menu");
        }
    }
    ...
    private void EnableGameUI()
    {
        if (gameUI != null)
        {
            ...
            Debug.Log("Game UI enabled for Settings Menu");
        }
    }
    ...
    private void DisableGameplay()
    {
        if (feedingManager != null)
        {
            ...
            Debug.Log("Gameplay disabled for Settings Menu");
        }
    }
    ...
    private void EnableGameplay()
    {
        if (feedingManager != null)
        {
            ...
            Debug.Log("Gameplay enabled for Settings Menu");
        }
    }
    ...
    void Update()
    {
        if (isMenuOpen && Input.GetMouseButtonDown(0))
        {
            ...
            {
                Debug.Log("Click detected outside the Settings Menu. Closing menu.");
                CloseMenu();
            }
            else
            {
                Debug.Log("Click detected on the Settings Menu or its elements. Menu remains open.");
            }
        }
    }
