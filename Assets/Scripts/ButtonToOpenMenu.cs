...
public class ButtonToOpenMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Menu initialized: Closed");
    }
    ...
    public void ToggleMenu()
    {
        if (isMenuOpen)
        {
            Debug.Log("ToggleMenu: Closing menu");
            CloseMenu();
        }
        else
        {
            Debug.Log("ToggleMenu: Opening menu");
            OpenMenu();
        }
    }
    ...
    void Update()
    {
        if (isMenuOpen && Input.GetMouseButtonDown(0))
        {
            ...
            {
                Debug.Log("Click detected outside the menu. Closing menu.");
                CloseMenu();
            }
            else
            {
                Debug.Log("Click detected on the menu or its elements. Menu remains open.");
            }
        }
    }
